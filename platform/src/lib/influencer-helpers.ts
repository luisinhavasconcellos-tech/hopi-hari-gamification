...
const NICHE_KEYWORDS: Record<NicheCategory, string[]> = {
  ...
  lgbt_pride: [
    "lgbt", "lgbtq", "lgbtqia", "pride", "orgulho", "drag", "drag queen",
    "queer", "diversidade", "arco-íris", "arco iris", "rainbow",
    "não-binário", "nao binario", "trans", "bissexual", "gay",
    "lésbica", "lesbica", "parada", "visibilidade",
  ],
  religious: [
    "igreja", "church", "deus", "god", "cristão", "cristao", "christian",
    "evangélico", "evangelico", "católico", "catolico", "fé", "faith",
    "gospel", "pastor", "oração", "oracao", "prayer", "bíblia", "biblia",
    "louvor", "worship", "culto", "devocional", "jesus", "cristo",
  ],
};
...
export function extractNiches(bio: string, name?: string): string[] {
  ...
  const map: Record<string, string> = {
    ...
    lgbt: "LGBT+ Pride", pride: "LGBT+ Pride", drag: "LGBT+ Pride",
    queer: "LGBT+ Pride", diversidade: "LGBT+ Pride",
