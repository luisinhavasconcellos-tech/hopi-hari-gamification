...
const NODES: Node[] = [
  // Social
  { area: "Social", label: "Seguidores diários", table: "follower_daily", origin: "Planilha oficial de seguidores", originKind: "sheet", fn: "sync-follower-log", dateCol: "reading_date", staleDays: 14, consumers: [{ label: "Base de seguidores", to: "/audience/followers" }, { label: "Visão geral", to: "/" }] },
  ...
  { area: "Social", label: "Posts Instagram", table: "instagram_posts", origin: "Apify (Instagram)", originKind: "api", fn: "scrape-instagram-apify", dateCol: "timestamp", staleDays: 14, consumers: [{ label: "Instagram", to: "/instagram" }, { label: "Posts", to: "/posts" }] },
  ...
  { area: "PDV / F&B", label: "Receita por outlet", table: "park_outlet_revenue_daily", origin: "PDV do parque", originKind: "manual", dateCol: "date", staleDays: 45, consumers: [{ label: "F&B", to: "/audience/fnb" }] },
  ...
  { area: "Vendas", label: "Funil B2B", table: "sales_funnel_deals", origin: "Planilha comercial", originKind: "sheet", dateCol: "updated_at", staleDays: 90, consumers: [{ label: "Funil de vendas", to: "/audience/sales-funnel" }] },
  { area: "Vendas", label: "Distribuidores", table: "distributor_sales_monthly", origin: "Relatório de distribuidores", originKind: "manual", dateCol: "updated_at", staleDays: 60, consumers: [{ label: "Distribuidores", to: "/audience/distributors" }] },

  // CRM & Clientes
  { area: "CRM & Clientes", label: "Leads por geografia", table: "crm_leads_geo", origin: "Exportação do CRM", originKind: "manual", dateCol: "updated_at", staleDays: 120, consumers: [{ label: "Leads CRM", to: "/audience/crm-leads" }] },
  { area: "CRM & Clientes", label: "Dimensões de leads", table: "crm_lead_dimensions", origin: "Exportação do CRM", originKind: "manual", dateCol: "updated_at", staleDays: 120, consumers: [{ label: "Leads CRM", to: "/audience/crm-leads" }] },
