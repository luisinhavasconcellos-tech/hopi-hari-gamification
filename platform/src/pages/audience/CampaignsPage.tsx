...
import { Activity, ExternalLink, Film, Image as ImageIcon, Megaphone, Sparkles, TrendingUp } from "lucide-react";
import {
  Bar,
  BarChart,
  CartesianGrid,
...
export default function CampaignsPage() {
  ...
  const [tab, setTab] = useState<"criativos" | "performance" | "correlacao" | "eventos">("criativos");
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="mt-6 flex flex-wrap gap-2">
        {(["criativos", "performance", "correlacao", "eventos"] as const).map((t) => (
          <button
            key={t}
            onClick={() => setTab(t)}
