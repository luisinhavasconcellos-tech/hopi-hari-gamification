import{S as e}from"./index-B28m_PeH.js";import"./logDepthDeclaration-07AmpNeU.js";import"./helperFunctions-Bj8XQFni.js";import"./meshUboDeclaration-BCcgMq4G.js";const o="decalFragmentDeclaration",P=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=P);const t="defaultFragmentDeclaration",X=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=X);const r="prePassDeclaration",F=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=F);const a="oitDeclaration",R=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=R);const n="lightFragmentDeclaration",N=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=N);const l="lightUboDeclaration",M=`#ifdef LIGHT{X}
uniform Light{X}
...
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=_);const d="lightsFragmentFunctions",y=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=y);const c="shadowsFragmentFunctions",b=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=b);const h="samplerFragmentDeclaration",U=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=U);const v="fresnelFunction",W=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=W);const u="reflectionFunction",H=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=H);const p="imageProcessingDeclaration",z=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=z);const m="imageProcessingFunctions",V=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=V);const g="bumpFragmentMainFunctions",G=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=G);const S="bumpFragmentFunctions",B=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=B);const E="fogFragmentDeclaration",k=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=k);const C="bumpFragment",Y=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=Y);const D="decalFragment",$=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=$);const L="depthPrePass",Z=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Z);const T="lightFragment",q=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=q);const I="logDepthFragment",Q=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=Q);const A="fogFragment",j=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=j);const w="oitFragment",J=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=J);const i="defaultPixelShader",x=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=x);const te={name:i,shader:x};export{te as defaultPixelShader};
