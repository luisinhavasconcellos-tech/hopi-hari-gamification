...
import { GenderAuditSection } from "@/pages/audience/GenderAuditPage";
...
export default function SegmentsPage() {
  ...
  return (
    <div className="px-5 lg:px-8 py-6">
      ...
      <section className="mt-10 border-t border-border/60 pt-8" aria-labelledby="gender-audit-title">
        <div className="mb-4">
          <div className="text-[11px] uppercase tracking-[0.18em] text-primary">Qualidade de dados</div>
          <h2 id="gender-audit-title" className="mt-1 font-display text-2xl tracking-tight">Auditoria de Gênero</h2>
          <p className="mt-1 max-w-3xl text-sm text-muted-foreground">
            A validação de gênero agora faz parte de Segmentos. Revise as amostras e acompanhe a qualidade das estimativas sem sair da análise de público.
          </p>
        </div>
        <GenderAuditSection embedded />
      </section>
    </div>
  );
}
