...
// Exportado para que o sign-out possa limpar o cache de KPIs.
export const AUDIENCE_KPI_CACHE_KEY = "audience-overview-cache-v5";
const CACHE_KEY = AUDIENCE_KPI_CACHE_KEY;
...
export default function AudienceIntelligencePage() {
  ...
  return (
    <div id="audience-overview-report" className="px-5 lg:px-8 py-6">
