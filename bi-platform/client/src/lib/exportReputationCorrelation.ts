...
export function exportCorrelationCsv(d: CorrelationExport) {
  // Células que começam com = + - @ (ou tab/CR) seriam executadas como fórmula pelo Excel
  // (CSV injection) — texto de avaliação alimenta temas/clusters, então neutraliza com apóstrofo.
