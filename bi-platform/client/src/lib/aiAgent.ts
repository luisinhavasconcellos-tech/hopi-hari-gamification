...
/**
 * DEMO STUB — não chama nenhum modelo nem lê dados reais.
 * Devolve uma estratégia fixa e fictícia ("1.2M seguidores", mix de conteúdo etc.) após um atraso simulado.
 * A UI que a exibe deve rotular o conteúdo como exemplo ilustrativo estático.
 */
...
/**
 * DEMO STUB — não chama nenhum modelo nem analisa seguidores reais.
 * Os sinais ("3,2%", "2.400 novos seguidores em 12/Mar") são texto fixo de demonstração.
 * A UI que o exibe deve rotular o conteúdo como exemplo ilustrativo estático.
 */
...
/**
 * DEMO STUB — chat com respostas pré-escritas escolhidas por palavra-chave; não chama nenhum LLM.
 * A UI que o exibe deve rotular o painel como exemplo ilustrativo (respostas estáticas).
 */
