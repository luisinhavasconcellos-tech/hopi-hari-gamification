      ...
      <div className="flex min-h-screen bg-background text-foreground font-sans">
        ...
        <main className="flex-1 min-w-0 w-full lg:ml-64 pt-14 lg:pt-0 pb-28">
          <Routes>
            ...
            <Route path="/admin/seguidores/importar" element={<ProtectedRoute adminOnly><FollowerImportPage /></ProtectedRoute>} />
            ...
            <Route path="/audience/admin" element={<ProtectedRoute adminOnly><AdminPage /></ProtectedRoute>} />
